...
addToBasketButton.addEventListener("click", function() {
  var product = {
    image: "/static/img/notepads/notepad1.webp",
    title: "notepad",
    price: 9
  ...
  addToBasketButton2.addEventListener("click", function() {
    var product = {
      image: "/static/img/notepads/notepad2.webp",
      title: "A4 notepad",
      price: 12
  ...
  addToBasketButton3.addEventListener("click", function() {
    var product = {
      image: "/static/img/notepads/notepad3.webp",
      title: "small notepad",
      price: 5
  ...
  addToBasketButton4.addEventListener("click", function() {
    var product = {
      image: "/static/img/notepads/notepad4.jpeg",
      title: "notepad with a pattern",
      price: 4.2
