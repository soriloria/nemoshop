...
addToBasketButton.addEventListener("click", function() {
  var product = {
    image: "/static/img/pencils/pencil1.jpg",
  ...
  addToBasketButton2.addEventListener("click", function() {
    var product = {
      image: "/static/img/pencils/pencil4.jpg",
  ...
  addToBasketButton3.addEventListener("click", function() {
    var product = {
      image: "/static/img/pencils/pencil3.jpg",
      title: "metal pencil",
      price: 5
  ...
  addToBasketButton4.addEventListener("click", function() {
    var product = {
      image: "/static/img/pencils/pencil2.jpg",
      title: "pencils of 12 colors",
      price: 1
